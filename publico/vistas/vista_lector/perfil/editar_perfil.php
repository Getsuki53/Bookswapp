...
// $conexion = new mysqli("localhost", "", "", "bookswap");
...
<head>
    ...
    <body>
        <header>
            <div class="logo">
                <img src="../../../recursos/imagenes/BookSwap-removebg-preview.png" alt="Logo BookSwap">
            </div>
            <div class="iconos">
                <a href="notificaciones.php"><i class="fas fa-bell"></i></a>
                <a href="../busqueda/buscar.php"><i class="fas fa-search"></i></a>
                <a href="../intercambio/mensajes.php"><i class="fas fa-envelope"></i></a>
            </div>
        </header>
        <main>
