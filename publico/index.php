...
<html lang="es">
    ...
    <body>
        ...
        <header>
            ...
            <nav>
                <div class="profile-icon" aria-label="Perfil de usuario">👤</div>
            </nav>
        </header>
        ...
        <main>
            <div class="content">
                ...
                <div class="text">
                    ...
                    <div class="buttons">
                        <a href="vistas/control_acceso/registrar.php" class="btn register">Regístrate aquí</a>
                        <a href="vistas/control_acceso/login.php" class="btn login">Inicia sesión</a>
                    </div>
                </div>

                <!-- Sección de imagen -->
                <div class="image">
                    <img src="recursos/imagenes/12-removebg-preview.png" alt="Imagen de libros sobre una laptop" class="main-img">
                </div>
            </div>
        </main>
