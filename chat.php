...
<head>
    ...
    <title>Chat - BookSwap</title>
    <link rel="stylesheet" href="chatfront.css">
</head>
<body>
    <header>
        <img src="img/logo.png" alt="BookSwap" class="logo">
        <h1>BookSwap Chat</h1>
    </header>
    <div class="chat-container">
        <div class="chat-box">
            <?php foreach ($mensajes as $mensaje): ?>
                <div class="chat-message <?php echo $mensaje['Men_usu_id'] == $usu_correo ? 'user-message' : 'other-message'; ?>">
                    <span class="user"><?php echo htmlspecialchars($mensaje['Men_usu_id']); ?></span>
                    <span class="date"><?php echo htmlspecialchars($mensaje['Men_fecha']); ?></span>
                    <p class="message"><?php echo htmlspecialchars($mensaje['Men_mensaje']); ?></p>
                </div>
            <?php endforeach; ?>
        </div>
